...
public class TancSoStudentite {
    ...
    static Semaphore maskiSoblekuvalna;
    static Semaphore zenskiSoblekuvalna;
    static Semaphore igraat;

    static Semaphore spremniZenski;


    public void init() {
        //TODO: da se implementira
        maskiSoblekuvalna = new Semaphore(10);
        zenskiSoblekuvalna = new Semaphore(10);


        spremniZenski = new Semaphore(0);


        igraat = new Semaphore(3);
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            ...
            maskiSoblekuvalna.release();
            zenskiSoblekuvalna.release();
            igraat.release();
        }
